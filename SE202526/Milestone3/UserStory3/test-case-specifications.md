...
| ------------- | ------------------------------------------------------------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| none          | Targeting broad (using custom map for testing targeting) | 1. Start a custom game in sandbox mode (preferably using "Test_Targeting_Map.msav"). | A new game is launched in sandbox mode.                                                                                                                                                                                                     |
...
| Pre Condition                          | Test Case Id        | Steps                                                 | Expected Result                                                                                                                                           |
| -------------------------------------- | ------------------- | ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Inside custom game <br>in sandbox mode | Targeting menu | 1. Place down any turret.                             | Turret is placed on the map.                                                                                                                              |
...
## Test Targeting Display

| Pre Condition               | Test Case Id           | Steps                     | Expected Result                                                                                                                                                                                                                                                                                                                                                |
| --------------------------- | ---------------------- | ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Custom game in sandbox mode | Targeting Display | 1. Place down any turret. | Turret is placed on the map.                                                                                                                                                                                                                                                                                                                                   |
...
## Test Targeting Option error

| Pre Condition               | Test Case Id                | Steps                                  | Expected Result                                                                                                                                           |
| --------------------------- | --------------------------- | -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Custom game in sandbox mode | Targeting Same option Error | 1. Place down any turret.              | Turret is placed on the map.                                                                                                                              |
|                             |                             | 2. Click the turret to select it       | Menu appears below turret. On the left a button "closest" appears.  <br>On the right a button "any" appears or grayed out text saying: "Air" or "Ground". |
|                             |                             | 3. Press one of the options or option. | A drop down menu of buttons appears below the pressed option (with one of the buttons being highlighted).                                                 |
|                             |                             | 4. Press the button "closest".         | An error message appears in flashing red in the middle top of the screen.                                                                                 |
