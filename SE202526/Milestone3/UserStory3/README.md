...
The arrows having the "return" text are a different style from what I used, instead fo being empty, but the lesson powerpoints also show return arrows in a variety of ways.
